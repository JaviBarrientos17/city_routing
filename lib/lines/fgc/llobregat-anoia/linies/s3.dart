...
class S3_Line extends StatefulWidget {
  @override
  _S3_LineState createState() => _S3_LineState();
}

class _S3_LineState extends State<S3_Line> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('S3', textAlign: TextAlign.center)),
      ),
      body: FutureBuilder(
  ...
  Future<void> _fetchFGCData() async {
    final data = await ApiService.fetchDataForRoute("S3");
