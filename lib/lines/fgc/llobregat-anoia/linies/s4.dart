...
class S4_Line extends StatefulWidget {
  @override
  _S4_LineState createState() => _S4_LineState();
}

class _S4_LineState extends State<S4_Line> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('S4', textAlign: TextAlign.center)),
      ),
      body: FutureBuilder(
  ...
  Future<void> _fetchFGCData() async {
    final data = await ApiService.fetchDataForRoute("S4");
