...
class S9_Line extends StatefulWidget {
  @override
  _S9_LineState createState() => _S9_LineState();
}

class _S9_LineState extends State<S9_Line> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('S9', textAlign: TextAlign.center)),
      ),
      body: FutureBuilder(
  ...
  Future<void> _fetchFGCData() async {
    final data = await ApiService.fetchDataForRoute("S9");
